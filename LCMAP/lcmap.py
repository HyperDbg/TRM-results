...
def longest_cmap(input_1, input_2):
    m = len(input_1)
    n = len(input_2)
    ...
    cmap = input_1[end_position - max_length:end_position]

    return cmap, max_length
...
result_cmap, result_length = longest_cmap(input_arr1, input_arr2)

print("Longest LCMAP:", result_acmap)
print("Length of LCMAP:", result_length)
