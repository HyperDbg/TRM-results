# TRM Tests Artifact Evaluation Guide

This guide provides step-by-step instructions for setting up and running the TRM tests associated with the artifact evaluation of our research article.
...
Replace the process ID with the `0x3578` in the following script and then run it.

```C
? .test_var = 0;

!mode k pid 0x3578 script {
	//
