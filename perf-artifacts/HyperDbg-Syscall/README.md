# HyperDbg SYSCALL Tests Artifact Evaluation Guide

This guide provides step-by-step instructions for setting up and running HyperDbg SYSCALL tests associated with the artifact evaluation of our research article.
...
Replace the process ID with the `0x24f0` in the following script and then run it.

```C
? .test_var = 0;

!syscall pid 0x24f0 script {
	//
