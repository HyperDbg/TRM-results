...
/* ===================================================================== */
/* Timing functions and global variables */
/* ===================================================================== */
uint64_t pin_global_timing = 0;
...
VOID PrintDynamicCounts(ofstream& out)
{
    ...
    // Execution ended
    //
    uint64_t pin_end_time = rdtscp();
    
    uint64_t diff = pin_end_time - pin_global_timing;
